...
[React Testing Library](https://testing-library.com) already setup for you: [isolate-components](https://www.npmjs.com/package/isolate-components), [React Testing Library](https://testing-library.com)
